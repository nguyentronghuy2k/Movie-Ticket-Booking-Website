...
<body>
	...
	<div class="main">
		...
		<ul id="option">
			<?php 
				if (isset($_GET['user'])) {
					...
					echo "<li id='option_li'><a href='sapchieu.php?user={$_GET['user']}' style='color:red;'>Sắp Chiếu</a></li>";
				}
				else {
					...
					echo "<li id='option_li'><a href='sapchieu.php' style='color:red;'>Sắp Chiếu</a></li>";
				}
			?>
		</ul>
		</nav>
		<div class="products-grid">
				<?php
						require('connect.php');
						$sql1 = "SELECT * FROM phim WHERE trangthai = N'Sắp Chiếu'";
