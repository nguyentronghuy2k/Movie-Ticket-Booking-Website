...
<body>
	...
	<div class="main">
		...
		<ul id="option">
			<?php 
				if (isset($_GET['user'])) {
					echo "<li id='option_li'><a href='list-film.php?user={$_GET['user']}' style='color:red;'>Tất Cả</a></li>";
					echo "<li id='option_li'><a href='dangchieu.php?user={$_GET['user']}' target='_blank'>Đang Chiếu</a></li>";
					echo "<li id='option_li'><a href='sapchieu.php?user={$_GET['user']}' target='_blank'>Sắp Chiếu</a></li>";
				}
				else {
					echo "<li id='option_li'><a href='list-film.php' style='color:red;'>Tất Cả</a></li>";
					echo "<li id='option_li'><a href='dangchieu.php' target='_blank'>Đang Chiếu</a></li>";
						...
						?>
							<div class="film-lists">
								<div class="product-images">
			 						<a href="detail.php?id=<?= $row['maphim'] ?> <?php if (isset($_GET['user'])) {echo "&amp;user={$_GET['user']}";} ?>" title="<?= $row['tenphim'] ?>" class="product-image">
										<img src="<?= $row['hinhanh'] ?>" style="height: 260px;width: 185px;">
									</a>
			 					</div>
			 					<div class="product-info">
			 						<h2 class="product-name"><a href="#" title="BLOODSHOT"><?= $row['tenphim'] ?></a></h2>
			 						<div class="info">
									...
									<div class="info">
										...
										<span class="info-normal"><?= $row['thoiluong'] ?> phút</span>
									</div>
									<div class="info">
